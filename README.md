...
1. **代理配置**：默认直连 Pixiv API，无需代理。如果你的网络环境需要代理，可在配置中设置 `proxy`
...
### v3.1.1
- 移除默认代理，改为直连 Pixiv API
- Docker 环境下无需额外配置代理即可使用
- 代理改为可选配置（特殊网络环境仍可手动设置）
